...
func SwimmingSpentCalories(lenghtPool, countPool int, duration, weight float64) float64 {
	meanSwimSpeed := swimmingMeanSpeed(lenghtPool, countPool, duration)
	swimmingCalories := (meanSwimSpeed + swimmingCaloriesMeanSpeedShift) * swimmingCaloriesWeightMultiplier * weight * duration
